...
function crearUsuario() {
   ...
   // Tu código:
   class Usuario {
      constructor(usuario, nombre, email, pasword){
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function(){
         ...
         let separarStrig = this.split("");
         let invertirArray = separarStrig.reverse();
         let unirArrayIvertido = invertirArray.join("");
          return unirArrayIvertido
      }
   }
